...
const httpsServer = https.createServer({
    cert: fs.readFileSync('../certificates/signed/1305876.crt'),
    key: fs.readFileSync('../certificates/signed/fusions.vivo.com.br.pem')
}, app);
...
httpsServer.listen(7002, () => {
    console.log("Servidor online na porta 7002!")
})
